...
public class TasksMenuScreen extends ScreenAdapter {
    ...
    private TasksMenuHUD tasksMenuHud;
    //tiled map values
    ...
    public TasksMenuScreen(GapGame game, AssetManager manager) {
        ...
        tasksMenuHud = new TasksMenuHUD(this.game, this.manager);
    ...
    public void render(float delta) {
        ...
        batch.setProjectionMatrix(tasksMenuHud.stage.getCamera().combined);
        tasksMenuHud.stage.draw();
    }

    @Override
    public void resize(int width, int height) {
        viewport.update(width, height);
        tasksMenuHud.resize(width, height);
    }
